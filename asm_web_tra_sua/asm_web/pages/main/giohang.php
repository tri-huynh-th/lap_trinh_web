<!-- ko cần session start vì index đã có -->
<p>
    <?php
...
<table style="width:100%;text-align:center;border-collapse:collapse;" border="1">
    ...
    <tr>
        <td><?php echo $i;?></td>
        <!-- trong ngoặc đơn '' là key mảng mình tự đặt chứ ko phải col trong database nhưng làm hãy đặt y như nhau đi -->
        <td><?php echo $cart_item['masp'];?></td>
        <td><?php echo $cart_item['tensp'];?></td>
        <!-- hinhanh từ index chính vào admincp -->
    ...
    <tr>
        <td colspan="8">
            ...
            <p style="float: right;"><a href="pages/main/themgiohang.php?xoatatca=1">Xoá tất cả</a>
            </p>
